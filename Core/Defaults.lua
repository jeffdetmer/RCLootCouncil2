...
addon.responses = {
	default = {
		...
		DEFAULT      = { color = { 1, 0, 0, 1, }, sort = 899,
			text = L["Response isn't available. Please upgrade RCLootCouncil."], },
...
addon.defaults = {
	...
	profile = {
		...
		-- ML - Buttons and responses - Buttons and responses
